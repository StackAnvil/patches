...
const lines = [
  ...
  "## Use the libraries", "",
  "The four project archives include a JAR, generated POM, SHA-256 manifest, and the ViaFabricPlus API JAR where needed. The [StackAnvil Maven repository](https://github.com/StackAnvil/maven) imports these archives under the matching release version.", "",
];
